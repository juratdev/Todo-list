...
function showTodos() {
  ...
  todos.forEach((item, i) => {
    ...
    <div class="todo-icons">
      ...
      <img onclick=(editTodo(${i})) src="./img/edit.svg" alt="edit icon" width="25px" height="25px" />
      <img onclick=(deleteTodo(${i})) src="./img/delete.svg" alt="delete icon" width="25px" height="25px" />
    </div>
    </li> 
    `
  })
